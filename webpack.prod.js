...
module.exports = merge(common, {
  ...
  plugins: [
    ...
    new PurgeCSSPlugin({
      ...
      safelist: {
        standard: ['active', 'leaflet-control-attribution', 'swiper-pagination-bullet', 'swiper-pagination-bullet-active', 'class-to-keep', /^dynamic-class-/], // Clases que no se deben purgar
